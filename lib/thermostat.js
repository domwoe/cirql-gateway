...
Thermostat.prototype.useTemperatureOffset = function() {
    ...
    if (this.lastOffset !== null) {
        ...
        var realOffset = Math.round((this.extTemp - (this.trvTemp - this.lastOffset)) * 10) / 10;


        this.fbRef.child('realOffset').set(realOffset);
                ...
                if (typeof value != 'undefined') {
                    if (property === 'burstRx' && (value.Value === 'off' || value.Value === 'off ')) {
                        ...
                        if (value.Value.match('set') === -1) {
                            self.lastOffset = parseFloat((value.Value).split('K')[0]);
                        }
                    }
