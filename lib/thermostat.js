...
Thermostat.prototype.useTemperatureOffset = function() {
    ...
    this.getPeeredSensor(function(error, sensorId) {
        ...
        this.peeredSensor = sensorId;
        if (sensorId + '' === this.virtualSensor + '' || sensorId + '' === 'extTemp_' + this.id + '_Btn1') {
            this.isPeered = true;
            this.unpeerVirtualSensor();
        } else {
            this.isPeered = false;
        }
    });

    var realOffset = (this.extTemp - this.trvTemp);
